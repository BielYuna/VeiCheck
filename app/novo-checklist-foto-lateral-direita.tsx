...
export default function NovoChecklistFotoLateralDireitaScreen() {
  ...
  const hasPhoto = useMemo(() => !!photos[2], [photos]);
  const photoUri = useMemo(() => photos[2] || '', [photos]);
  ...
  const handleAvancar = () => {
    if (!hasPhoto) return;
    router.push('/novo-checklist-avarias-lateral-direita');
  };
    ...
    <ThemedView style={[styles.container, { paddingTop: insets.top }]}> 
      ...
      <Animated.View
        ...
        <ThemedText style={[styles.messageText, { fontSize: 24, fontWeight: '600', margin: 16 }]}> 
          Foto da lateral direita do veículo
        </ThemedText>
      </Animated.View>
      ...
      <Animated.View
        ...
        <View style={styles.photosContainer}>
          ...
          <ThemedText style={styles.photoHintText}>
            Toque para {hasPhoto ? 'remover' : 'adicionar'} a foto da lateral direita do veículo
          </ThemedText>
        </View>
      </Animated.View>
