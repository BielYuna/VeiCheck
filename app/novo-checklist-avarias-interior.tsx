...
export default function NovoChecklistAvariasInteriorScreen() {
  ...
  const canSubmit = useMemo(() => {
    return interiorItems.every((item) => !!avarias[item]);
  }, [avarias]);
  ...
  return (
    <ThemedView style={[styles.container, { paddingTop: insets.top }]}> 
      <View style={styles.progressBarContainer}>
        <View style={[styles.progressBar, { width: '89%', backgroundColor: '#51eb7c' }]} />
      </View>
      ...
      <Animated.View
        ...
        <ThemedText style={[styles.messageText, { fontSize: 24, fontWeight: '600', margin: 16 }]}> 
          Avarias no interior do veículo
        </ThemedText>
      </Animated.View>
      ...
      <Animated.View
        ...
        <View style={styles.avariasContainer}>
          <ThemedText style={[styles.sectionTitle, { marginBottom: 8 }]}>Parte interior (marque uma opção):</ThemedText>
          <ScrollView
