...
export default function NovoChecklistFotoLateralEsquerdaScreen() {
  ...
  const hasPhoto = useMemo(() => !!photos[3], [photos]);
  const photoUri = useMemo(() => photos[3] || '', [photos]);
  ...
  const handleAvancar = () => {
    if (!hasPhoto) return;
    router.push('/novo-checklist-avarias-lateral-esquerda');
  };

  return (
    <ThemedView style={[styles.container, { paddingTop: insets.top }]}> 
      <View style={styles.progressBarContainer}>
        <View style={[styles.progressBar, { width: '61%', backgroundColor: '#51eb7c' }]} />
      </View>
      ...
      <Animated.View
        ...
        <ThemedText style={[styles.messageText, { fontSize: 24, fontWeight: '600', margin: 16 }]}> 
          Foto da lateral esquerda do veículo
        </ThemedText>
      </Animated.View>
      ...
      <Animated.View
        ...
        <View style={styles.photosContainer}>
          ...
          <ThemedText style={styles.photoHintText}>
            Toque para {hasPhoto ? 'remover' : 'adicionar'} a foto da lateral esquerda do veículo
          </ThemedText>
        </View>
      </Animated.View>
