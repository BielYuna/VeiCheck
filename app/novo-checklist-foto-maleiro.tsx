...
export default function NovoChecklistFotoMaleiroScreen() {
  ...
  const hasPhoto = useMemo(() => !!photos[4], [photos]);
  ...
  const handleAvancar = () => {
    if (!hasPhoto) return;
    router.push('/novo-checklist-avarias-maleiro');
  };
      ...
      <Animated.View
        ...
        <View style={styles.photosContainer}>
          ...
          <ThemedText style={styles.photoHintText}>
            Toque para {hasPhoto ? 'remover' : 'adicionar'} a foto do maleiro do veículo
          </ThemedText>
        </View>
      </Animated.View>
